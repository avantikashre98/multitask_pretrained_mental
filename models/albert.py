...
class ALBERT_clf(nn.Module):
    def __init__(self, num_classes):
        super(ALBERT_clf, self).__init__()
        self.num_classes = num_classes
        
        #PreTrained
        self.albert = AlbertModel.from_pretrained("albert/albert-base-v2")
    ...
    def forward(self, input_id, attention_mask, labels=None):
        outputs = self.albert(input_ids=input_id, attention_mask=attention_mask)
